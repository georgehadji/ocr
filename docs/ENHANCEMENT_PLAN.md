...
| **A8** | Real lexicon + confusion model | **Done.** 2.46M forms across three sources replace 117 hardcoded words; a lexicon miss now carries candidate readings. Measured on human-correct text, the false-flag rate is 9.7% (was 68% before the orthography fix). See docs/ENGINE_ACCURACY.md. | 5 |
